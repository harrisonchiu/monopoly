...
class Controller {
  ...
  using debug_actions = std::function<ExitCodes(Controller *, args_list &args)>;
...
public:
  ...
  auto run_command(args_list &args) -> ExitCodes;
  ...
  auto exit(args_list &args) -> ExitCodes;
  auto redraw(args_list &args) -> ExitCodes;
};
